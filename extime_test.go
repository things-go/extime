...
func TestStartAndEndOfQuarter(t *testing.T) {
	t.Log(StartOfQuarter(2022, Quarter1th))
	t.Log(PreviousStartOfQuarter(2022, Quarter1th))
	t.Log(NextStartOfQuarter(2022, Quarter1th))

	t.Log(StartOfQuarter(2022, Quarter2th))
	t.Log(PreviousStartOfQuarter(2022, Quarter2th))
	t.Log(NextStartOfQuarter(2022, Quarter2th))

	t.Log(StartOfQuarter(2022, Quarter3th))
	t.Log(PreviousStartOfQuarter(2022, Quarter3th))
	t.Log(NextStartOfQuarter(2022, Quarter3th))

	t.Log(StartOfQuarter(2022, Quarter4th))
	t.Log(PreviousStartOfQuarter(2022, Quarter4th))
	t.Log(NextStartOfQuarter(2022, Quarter4th))

	t.Log(EndOfQuarter(2022, Quarter1th))
	t.Log(PreviousEndOfQuarter(2022, Quarter1th))
	t.Log(NextEndOfQuarter(2022, Quarter1th))
}
